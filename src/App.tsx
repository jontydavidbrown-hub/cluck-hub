...
function MobileDrawer({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  const links = [
    ...
    { to: "/setup", label: "Setup" }, { to: "/analytics", label: "Analytics" }, { to: "/members", label: "Members" }, { to: "/user", label: "User" },
  ];
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-16 flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-1 text-sm">
              ...
              <NavItem to="/setup">Setup</NavItem><NavItem to="/analytics">Analytics</NavItem><NavItem to="/members">Members</NavItem><NavItem to="/user">User</NavItem>
            </nav>
            <HeaderFarmSelector />
          </div>
        </div>
